...
class App extends Component {
  ...
  addItem = (name, salary) => {
    ...
    // console.log(`добавляем в data ${name} с зп ${salary}`)
    this.setState(({data}) => {
  ...
  render() {
    ...
    const employees_count = this.state.data.length;
    const increased_count = this.state.data.filter(item => item.increase).length;
